...
- [Benign signatures](benign-signatures.md) — vswhere/qpa.screen/D9025 noise, Grep's `\`-for-`//` artifact, no-op builds, orphaned krait-render-tests.exe
- [D9025 std override](d9025-std-override.md) — open: 14x c++17→c++23preview warnings in krait-app; /WX does not catch D-series
- [Suite health](suite-health.md) — no flaky tests known; count history (609 @ T84), the scrollback test dominates runtime, bench variance
